...
I = cv2.imread("spec/Specim IQ/510_grayscale_100.png")
...
def cropText(img,clear_image):
    ...
    contours, hierarchy = cv2.findContours(dilation, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_NONE)  # This method returns 3 variables for getting contours
...
# gre_eq = cv2.cvtColor(eq,cv2.COLOR_BGR2GRAY)
Values_eq = eq.ravel()#unravelled from matrix form to a 1D
