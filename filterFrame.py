...
class FilterFrame(Toplevel):
    ...
    def __init__(self, master=None):
        ...
        self.negative_button = Button(master=self, text="Negative", width=10)
        self.black_white_button = Button(master=self, text="Black White", width=10)
        self.sepia_button = Button(master=self, text="Sepia", width=10)
        self.emboss_button = Button(master=self, text="Emboss", width=10)
        self.gaussian_blur_button = Button(master=self, text="Gaussian Blur", width=10)
        self.median_blur_button = Button(master=self, text="Median Blur", width=10)
        self.cancel_button = Button(master=self, text="Cancel", width=7)
        self.apply_button = Button(master=self, text="Apply", width=7)
